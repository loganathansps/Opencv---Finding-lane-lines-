...
os.chdir('test_videos') #navigate to the directory containing sample videos
...
cap = cv2.VideoCapture('solidYellowLeft.mp4')  #load the desired sample video
while(cap.isOpened()):
    _,image = cap.read()
